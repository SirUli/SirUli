...
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v2.2.15](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v2.2.15), 5 days ago) - A Home Assistant App (ex addon) to provide Ollama for AI
...
- [IamBlum/pm-copilot](https://github.com/IamBlum/pm-copilot) - A co-pilot for Claude that learns how you work and runs your weekly PM overhead: morning brief, weekly prep, open loops, and self-improvement. Tool-agnostic; runs in Claude Cowork or Claude Code. (3 days ago)
