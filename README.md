...
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.6.1](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.6.1), 4 days ago) - A Home Assistant integration to provide battery notes of devices
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v1.1.31](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v1.1.31), 6 days ago) - Provides an Home Assistant addon for Ollama
...
- [pgflo/pg_flo](https://github.com/pgflo/pg_flo) - Stream, transform, and route PostgreSQL data in real-time. (1 week ago)
