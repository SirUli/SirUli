...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.2.0a0](https://github.com/ansible/ansible-lint/releases/tag/v6.2.0a0), 2 days ago) - Best practices checker for Ansible
...
- [CestLaGalere/weathersummary](https://github.com/CestLaGalere/weathersummary) - summarises data from weather component for Home Assistant. E.g. get min / max temp over last 24 hours, predicted rainfall. (1 day ago)
