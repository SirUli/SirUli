...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.6.0](https://github.com/ansible/ansible-lint/releases/tag/v6.6.0), 1 day ago) - Best practices checker for Ansible
- [SirUli/victron-dbus-fronius-smartmeter](https://github.com/SirUli/victron-dbus-fronius-smartmeter) ([v1.6](https://github.com/SirUli/victron-dbus-fronius-smartmeter/releases/tag/v1.6), 3 days ago) - Integration of Fronius Smartmeters into the Victron VenusOS environment via dbus
...
- [victronenergy/dbus-spy](https://github.com/victronenergy/dbus-spy) -  (6 days ago)
- [hans-olav/dbus-nextion](https://github.com/hans-olav/dbus-nextion) - Nextion LCD integration with Victron Energy equipment on Raspberry Pi (6 days ago)
- [liaan/victron-dbus-mqtt-ro](https://github.com/liaan/victron-dbus-mqtt-ro) - Victron Dbus-mqtt  Read Only version just pushing data all the time to mqtt (6 days ago)
