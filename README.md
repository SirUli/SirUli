...
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v2.0.109](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v2.0.109), 2 days ago) - A Home Assistant App (ex addon) to provide Ollama for AI
...
- [Ataraxy-Labs/sem](https://github.com/Ataraxy-Labs/sem) - Semantic version control =&gt; entity-level diffs, blame, and impact analysis on top of git. 28 languages via tree-sitter. Built for coding agents. (3 weeks ago)
