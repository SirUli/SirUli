...
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.9.9](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.9.9), 2 days ago) - A Home Assistant integration to provide battery notes of devices
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v2.0.6](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v2.0.6), 3 days ago) - Provides an Home Assistant addon for Ollama
