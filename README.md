...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([37.173.0](https://github.com/renovatebot/renovate/releases/tag/37.173.0), today) - Universal dependency automation tool.
...
- [Change external url of gitlab](https://wolf-u.li/en/change-external-url-of-gitlab/) (1 week ago)
- [Home Assistant: Change file without core running](https://wolf-u.li/en/homeassistant-change-file-without-core-running/) (1 week ago)
...
- [rednblkx/HomeKey-ESP32](https://github.com/rednblkx/HomeKey-ESP32) - ESP32 HomeKit Lock with added HomeKey functionality (1 day ago)
- [jordaneremieff/mangum](https://github.com/jordaneremieff/mangum) - AWS Lambda support for ASGI applications (6 days ago)
