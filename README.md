...
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.6.3](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.6.3), today) - A Home Assistant integration to provide battery notes of devices
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v1.1.34](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v1.1.34), today) - Provides an Home Assistant addon for Ollama
