...
- [keesschollaart81/vscode-home-assistant](https://github.com/keesschollaart81/vscode-home-assistant) ([v1.30.0](https://github.com/keesschollaart81/vscode-home-assistant/releases/tag/v1.30.0), 3 days ago) - Visual Studio Code Extension for Home Assistant. ⭐ if you think this is cool!
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.2.2](https://github.com/ansible/ansible-lint/releases/tag/v6.2.2), 3 days ago) - Best practices checker for Ansible
...
- [fboender/ansible-cmdb](https://github.com/fboender/ansible-cmdb) - Generate host overview from ansible fact gathering output (2 months ago)
