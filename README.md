...
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v2.0.12](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v2.0.12), 4 days ago) - Provides an Home Assistant addon for Ollama
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.9.11](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.9.11), 3 weeks ago) - A Home Assistant integration to provide battery notes of devices
