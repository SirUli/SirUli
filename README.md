...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.4.0](https://github.com/ansible/ansible-lint/releases/tag/v6.4.0), 2 days ago) - Best practices checker for Ansible
...
- [Homeassistant - binary_sensor Zustand an KNX übertragen](https://wolf-u.li/homeassistant-binary-sensor-zustand-an-knx-uebertragen/) (5 days ago)
- [Fensterkontakt für Velux Dachfenster](https://wolf-u.li/fensterkontakt-fuer-velux-dachfenster/) (5 days ago)
...
- [fernwerker/ownDynDNS](https://github.com/fernwerker/ownDynDNS) - Self-hosted dynamic DNS php script for FRITZ!Box and netcup DNS API (2 days ago)
