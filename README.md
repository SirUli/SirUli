...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([36.93.3](https://github.com/renovatebot/renovate/releases/tag/36.93.3), today) - Universal dependency update tool that fits into your workflows.
- [kwindrem/SetupHelper](https://github.com/kwindrem/SetupHelper) ([latest](https://github.com/kwindrem/SetupHelper/releases/tag/latest), 4 days ago) - Helper functions to simplify writing setup scripts that modify VenusOs functionality. The package includes automatic reinstallation of the package after a VenusOs update.
...
- [BIGTREETECH EBB36 5V tolerant pins](https://wolf-u.li/en/bigtreetech-ebb36-5v-tolerant-pins/) (2 months ago)
- [BIGTREETECH Manta E3EZ Fan voltage](https://wolf-u.li/bigtreetech-manta-e3ez-fan-voltage/) (2 months ago)
