...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([37.89.7](https://github.com/renovatebot/renovate/releases/tag/37.89.7), today) - Universal dependency update tool that fits into your workflows.
...
- [johannmx/paperless-ngx_backup](https://github.com/johannmx/paperless-ngx_backup) - Backs up Paperless-ngx files and directories automatically (docker container) with notifications (AppRise intregration) (4 days ago)
- [tb1337/paperless-api](https://github.com/tb1337/paperless-api) - Little paperless-ngx REST API wrapper. (4 days ago)
- [jgillula/paperless-ngx-postprocessor](https://github.com/jgillula/paperless-ngx-postprocessor) - A powerful and customizable postprocessing script for paperless-ngx (4 days ago)
- [deepdoctection/deepdoctection](https://github.com/deepdoctection/deepdoctection) - A Repo For Document AI (4 days ago)
