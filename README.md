...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.11.0](https://github.com/ansible/ansible-lint/releases/tag/v6.11.0), today) - ansible-lint checks playbooks for practices and behavior that could potentially be improved
