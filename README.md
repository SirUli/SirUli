...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.5.1](https://github.com/ansible/ansible-lint/releases/tag/v6.5.1), 1 week ago) - Best practices checker for Ansible
