...
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v2.0.108](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v2.0.108), 6 days ago) - A Home Assistant App (ex addon) to provide Ollama for AI
...
- [TECH7Fox/sipcore-hass-integration](https://github.com/TECH7Fox/sipcore-hass-integration) - A SIP client inside home assistant! (3 weeks ago)
