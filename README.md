...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([38.17.1](https://github.com/renovatebot/renovate/releases/tag/38.17.1), 1 day ago) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v1.1.16](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v1.1.16), 5 days ago) - Provides an Home Assistant addon for Ollama
...
- [Home Assistant: ZHA OTA Updates](https://wolf-u.li/homeassistant-zha-ota-updates/) (1 week ago)
...
- [tomasvotava/fastapi-sso](https://github.com/tomasvotava/fastapi-sso) - FastAPI plugin to enable SSO to most common providers (such as Facebook login, Google login and login via Microsoft Office 365 Account) (2 days ago)
- [MakeMagazinDE/Sandmaltisch](https://github.com/MakeMagazinDE/Sandmaltisch) - IKEA Sandmaltisch Hack Make 4/24 (3 days ago)
