...
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.4.2](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.4.2), 6 days ago) - A Home Assistant integration to provide battery notes of devices
...
- [Home Assistant: ZHA OTA Updates](https://wolf-u.li/homeassistant-zha-ota-updates/) (4 weeks ago)
...
- [sinaatalay/rendercv](https://github.com/sinaatalay/rendercv) - A LaTeX CV/Resume Framework (4 days ago)
...
- [winglang/wing](https://github.com/winglang/wing) - A programming language for the cloud ☁️ A unified programming model, combining infrastructure and runtime code into one language ⚡ (4 weeks ago)
