...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.6.0](https://github.com/ansible/ansible-lint/releases/tag/v6.6.0), 2 days ago) - Best practices checker for Ansible
- [SirUli/victron-dbus-fronius-smartmeter](https://github.com/SirUli/victron-dbus-fronius-smartmeter) ([v1.6](https://github.com/SirUli/victron-dbus-fronius-smartmeter/releases/tag/v1.6), 4 days ago) - Integration of Fronius Smartmeters into the Victron VenusOS environment via dbus
