...
- [kwindrem/SetupHelper](https://github.com/kwindrem/SetupHelper) ([v4.36](https://github.com/kwindrem/SetupHelper/releases/tag/v4.36), 1 day ago) - Helper functions to simplify writing setup scripts that modify VenusOs functionality. The package includes automatic reinstallation of the package after a VenusOs update.
