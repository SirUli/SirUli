...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.8.6](https://github.com/ansible/ansible-lint/releases/tag/v6.8.6), today) - Best practices checker for Ansible
