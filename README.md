...
- [SirUli/OneWireTest4iButton](https://github.com/SirUli/OneWireTest4iButton) - Testing the iButton (See Blog: https://wolf-u.li) (6 months ago)
...
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.6.0](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.6.0), 3 days ago) - A Home Assistant integration to provide battery notes of devices
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v1.1.30](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v1.1.30), 3 days ago) - Provides an Home Assistant addon for Ollama
...
- [Gira Steckdose mit LED-Orientierungsleuchte (z.b. 417003) - Bilder und Ansichten](https://wolf-u.li/gira-steckdose-mit-led-leuchte-417003/) (5 months ago)
...
- [Sensus 620 Wasserzähler: Smart machen via ESPHome](https://wolf-u.li/sensus-620-wasserzaehler-smart-machen/) (8 months ago)
- [Paperless-ngx ASN mit Avery L4731 labels](https://wolf-u.li/paperless-ngx-asn-mit-avery-l4731-labels/) (9 months ago)
...
- [barvian/number-flow](https://github.com/barvian/number-flow) - A component to transition, format, and localize numbers. (3 weeks ago)
