...
- [SirUli/homeassistant-ollama-addon](https://github.com/SirUli/homeassistant-ollama-addon) ([v2.0.16](https://github.com/SirUli/homeassistant-ollama-addon/releases/tag/v2.0.16), 4 days ago) - Provides an Home Assistant addon for Ollama
- [andrew-codechimp/HA-Battery-Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ([2.10.5](https://github.com/andrew-codechimp/HA-Battery-Notes/releases/tag/2.10.5), 5 days ago) - A Home Assistant integration to provide battery notes of devices
...
- [marmelab/shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) - Component kit to build your Admin app with shadcn/ui (4 days ago)
- [mhaeuser/Battery-Toolkit](https://github.com/mhaeuser/Battery-Toolkit) - Control the platform power state of your Apple Silicon Mac. (2 weeks ago)
