...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.8.0](https://github.com/ansible/ansible-lint/releases/tag/v6.8.0), 2 days ago) - Best practices checker for Ansible
