...
- [ansible/ansible-lint](https://github.com/ansible/ansible-lint) ([v6.5.0](https://github.com/ansible/ansible-lint/releases/tag/v6.5.0), 2 days ago) - Best practices checker for Ansible
...
- [trixing/venus.dbus-fronius-smartmeter](https://github.com/trixing/venus.dbus-fronius-smartmeter) - A service for Venus OS, reading smart meter data from a Fronius system and making the values available on dbus. (5 days ago)
